            ...
            <div class="image">
                @if (auth()->user()->avatar)
                    <img src="{{ asset('images/avatars/' . auth()->user()->avatar) }}" class="img-circle elevation-2"
                        alt="User Image">
                @else
                    <img src="{{ asset('images/avatars/1688305003_8 Grunge Yes No Icon PNG Transparent  OnlyGFX.com_thumbnail.png') }}"
                ...
                @elseif (auth()->user()->role == 'prof')
                    <li class="nav-item">
                        <a href="{{ Route('event.create') }}" class="nav-link">
                            <img src="{{ asset('assets/images/project_images/icons8-class-50.png') }}" class="nav-icon"
                                alt="">
