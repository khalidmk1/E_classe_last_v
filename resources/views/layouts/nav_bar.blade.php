            ...
            <li class="nav-item dropdown">
                <a class="nav-link" data-toggle="dropdown" href="#">
                    ...
                    <span class="badge badge-warning navbar-badge">
                        {{ App\Models\User::where('confirmed', 0)->count() }}</span>
                </a>
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <div class="dropdown-divider"></div>
                    <a href="{{ Route('table.demande') }}" class="dropdown-item dropdown-footer">Voir toute les
                        demande</a>
                </div>
        ...
        @else
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <div class="dropdown-divider"></div>
                    <a href="{{ Route('folow.accepte') }}" class="dropdown-item dropdown-footer">Voir toute les
                        demande</a>
                </div>
