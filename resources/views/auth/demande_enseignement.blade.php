                    ...
                    <div class="row g-0">
                                    ...
                                    <div class="col-md-6 mb-4 pb-2">
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control" name="last_name"
                                                placeholder="Prenom" value="{{ old('last_name') }}" required autofocus
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group flex-row-reverse">
                                            ...
                                            <input type="text" name="phone" class="form-control"
                                                data-inputmask='"mask": "999 999 9999"' data-mask placeholder="Telephone"
                        ...
                        <div class="col-lg-6 bg-indigo text-white">
                            <div class="p-5">
                                ...
                                <div class="input-group mb-4 pb-2">
                                    <label class="form-label col-12" for="form3Examplev2">Ajouter photo de
                                        cin</label>
                                    <div class="custom-file">
                                        <input type="file" name="cin" class="custom-file-input custom-file-label"
                                            id="exampleInputFile">
                                ...
                                <div class="input-group mb-4 pb-2 ">
                                    <label class="form-label col-12" for="form3Examplev2">Ajouter photo de
                                        license</label>
                                    <div class="custom-file">
                                        <input type="file" name="license" class="custom-file-input custom-file-label"
                            ...
                            <div class="form-check d-flex justify-content-start mb-4 pb-3">
                                <input class="form-check-input me-3" name="terms" value="agree" type="checkbox"
                                    id="form2Example3c" />
